...
export default function SmartNavbar({ initialTop = 100 }) {
    ...
    return (
        <nav
            className={`fixed left-1/2 -translate-x-1/2 z-50 flex justify-center w-full transition-all duration-300 ease-in-out ${visible ? "opacity-100 scale-100" : "opacity-0 scale-95"
                } ${pinnedToTop ? "top-0" : "top-[8vh]"}`}
        >


            <nav className={`bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700  ${visible ? "w-[90%]  rounded-lg" : "w-[90%]  rounded-lg"} ${pinnedToTop ? "w-[100%]  rounded-none" : "w-[90%]  rounded-lg"}`}>
